...
data = pd.read_pickle(ospath.join(folder_path, "mnist_scs_L120_K6_D2_data_1200_by_784_03.27.45.012592.pkl")) # 3 classes
print(data['Color'])
...
np.save(ospath.join(folder_path, "distances_3.npy"), distances)