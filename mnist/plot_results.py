...
for j in range(0,4):
    plt.plot(lcd[j,1:]/3, label = r"Least Confidence&Similarity - ($\alpha$="+str(j*0.25)+")", marker=markers[m])
    m+=1
plt.plot(lcd[4,1:]/3, label = r"Least Confidence", marker=markers[m])
m+=1
...
# for j in range(0,4):
#     plt.plot(lcd[j,1:]/3, label = r"Entropy&Similarity - ($\alpha$="+str(j*0.25)+")", marker=markers[m])
#     m+=1
# plt.plot(lcd[4,1:]/3, label = r"Entropy", marker=markers[m])
# m+=1
...
# for j in range(0,4):
#     plt.plot(lcd[j,1:]/3, label = r"Margin Sampling&Similarity - ($\alpha$="+str(j*0.25)+")", marker=markers[m])
#     m+=1
# plt.plot(lcd[4,1:]/3, label = r"Margin Sampling", marker=markers[m])
# m+=1
...
ax.legend(loc='lower right')#loc='upper right', bbox_to_anchor=(2,1))#loc = "best")
...
# plt.savefig("results/3class_l1_plots/L1_least_confidence.png", dpi=100, bbox_inches='tight')
plt.savefig("results/3class_plots/3_least_confidence.png", dpi=100, bbox_inches='tight')
# plt.savefig("results/3class_plots/zoomed_3_entropy.png", dpi=100, bbox_inches='tight')
